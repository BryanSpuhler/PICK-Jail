...
subtitle: "Revised Quantitative Analyses and Results: Dropping Non-Significant Predictors and Using all Available Data"
...
load(file="./Data/Jail_clean_longlong4.Rda", verbose = FALSE)
load(file="./Data/Jail_clean_long2.Rda", verbose = FALSE)
load(file="./Data/Jail_clean.Rda", verbose = FALSE)
load(file="./Data/Jail_clean.fscore_long.Rda", verbose = FALSE)
...
Jail_clean %>% 
    ...
    dplyr::mutate(`In Analysis Sample4` = factor(in.analysis.sample4)) %>% 
...
```{r, include=FALSE}
Model.2.ML <- lme4::lmer(Score ~ Ethnic_Code + 
...
```{r, include=FALSE}
Model.1.ML <- lme4::lmer(Score ~ Ethnic_Code + 
...
```{r, echo=FALSE}
Model.4.ML <- lme4::lmer(Score ~ Ethnic_Code + 
...
```{r, include=FALSE}
Model.3.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + 
                             (1|ID),
                         data = Jail_clean_longlong4,
                         REML = FALSE)
...
```{r, include=FALSE}
Model.6.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
...
```{r, include=FALSE}
Model.5.2.no.Dos.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                                      Time + Domain + Time:Domain +
...
```{r, include=FALSE}
Model.5.1.no.Exp.ML <- lme4::lmer(Score ~ Ethnic_Code +
                                      Time + Domain + Time:Domain +
                                      Number_Attended + Prior_RshpEducation_collapsed + 
                                      Time:Number_Attended + 
                                      (1|ID),
...
```{r, include=FALSE}
Model.5.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Number_Attended + Prior_RshpEducation_collapsed + 
                             (1|ID),
                         data = Jail_clean_longlong4,
...
The effect of Dosage and Prior Exposure was not significant ($\chi^2$ = `r format_chi(compar.dos.exp$Chisq[2])`, *df* = `r compar.dos.exp$"Chi Df"[2]`, `r pvaluer_anova(compar.dos.exp$"Pr(>Chisq)"[2])`).
...
Model.6.Attend2.base <- lme4::lmer(Score ~ Ethnic_Code + 
                                       Time + Domain + Time:Domain +
                                       Number_Attended + Prior_RshpEducation_collapsed + 
                                       Time:Number_Attended + 
                                       Time:Prior_RshpEducation_collapsed + 
...
Model.6.Attend3.base <- lme4::lmer(Score ~ Ethnic_Code + 
                                       Time + Domain + Time:Domain +
                                       Number_Attended + Prior_RshpEducation_collapsed + 
                                       Time:Number_Attended + 
                                       Time:Prior_RshpEducation_collapsed + 
...
# Race/Ethnicity
Model.7.2.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                               Time + Domain + Time:Domain +
                               Prior_RshpEducation_collapsed + Number_Attended + 
                               Time:Prior_RshpEducation_collapsed + 
                               Time:Number_Attended + 
...
```{r, echo=FALSE}
Model.8.REML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
```{r, echo = FALSE}
ggplot(data.frame(lev=hatvalues(Model.8.REML),
...
Model.8.REML@frame[levId,c("Score","Ethnic_Code", 
...
```{r, echo = FALSE}
summary(Model.8.REML@frame[,c("Score","Ethnic_Code", 
                           "Time", "Domain", "Prior_RshpEducation_collapsed",
                           "Number_Attended",
                           "ID")])
...
mmLev <- lme4::lmer(Score ~ Ethnic_Code + 
                            Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
```{r, echo=FALSE}
Model.9.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
Model.9.noTXRace.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
Model.9.noTXDos.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             # Time:Number_Attended + 
...
Model.9.noTXExp.ML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             # Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
Model.9.noTXDom.ML <- lme4::lmer(Score ~ Ethnic_Code +
                             Time + Domain + 
                                 # Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended +
                             Time:Prior_RshpEducation_collapsed +
...
```{r, echo = FALSE}
Model.9.RE <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
Model.9.RE.KR <- lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
* Comparing: 
    * Original Model (N = 134)
    * Trimmed Model (N = 134): Removing all non-significant predictors from the model
    * Trimmed Model (N = 165): Rerunning model with all available data. There were 31 cases gained because they were only missing on non-significant predictors.

```{r, include = FALSE}

# Original Model

Model.9.RE.KR.with.nsigpreds <- lmerTest::lmer(Score ~ Age_Decades + Ethnic_Code + 
                             ...
                             # Time:Divorced_Dichotomous +
                             (1|ID),
                         data = Jail_clean_longlong2,
                         REML = TRUE)



Orig.Coef <- (summary(Model.9.RE.KR.with.nsigpreds, 
                      ddf = "Kenward-Roger"))$coefficients %>% 
                      data.frame() %>% 
                      tibble::rownames_to_column() %>% 
                      dplyr::mutate(Predictor = rowname) %>% 
                      dplyr::select(Predictor, 
                                    Estimate, 
                                    Pr...t..) %>% 
                      # round(digits = 6) %>% 
                      dplyr::mutate(`Orig. Mod. Est.` = Estimate) %>% 
                      dplyr::mutate(`Orig. p` = Pr...t..) %>% 
                      dplyr::select(Predictor, `Orig. Mod. Est.`, `Orig. p`)

# Model Trimmed of Non Signifiant Predictors using same sample

Model.9.RE.KR.trim <- lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
Trim.Coef <- (summary(Model.9.RE.KR.trim, ddf = "Kenward-Roger"))$coefficients %>% 
                       data.frame() %>% 
                       tibble::rownames_to_column() %>% 
                       dplyr::mutate(Predictor = rowname) %>% 
                       dplyr::select(Predictor, Estimate, Pr...t..) %>% 
                       # round(digits = 6) %>% 
                       dplyr::mutate(`Trim. Mod. Est.` = Estimate) %>% 
                       dplyr::mutate(`Trim. p` = Pr...t..) %>% 
                       dplyr::select(Predictor, `Trim. Mod. Est.`, `Trim. p`)


# Model Trimmed of Non Signifiant Predictors using all available data

Trim.Coef.All.N <- (summary(Model.9.RE.KR, ddf = "Kenward-Roger"))$coefficients %>% 
     data.frame() %>% 
     tibble::rownames_to_column() %>% 
     dplyr::mutate(Predictor = rowname) %>% 
     dplyr::select(Predictor, Estimate, Pr...t..) %>% 
     # round(digits = 6) %>% 
     dplyr::mutate(`Trim. All N Mod. Est.` = Estimate) %>% 
     dplyr::mutate(`Trim. All N p` = Pr...t..) %>% 
     dplyr::select(Predictor, 
                   `Trim. All N Mod. Est.`, 
                   `Trim. All N p`)


# Joining estimates into data frame

Mod.ests <- dplyr::left_join(Orig.Coef, Trim.Coef, by = "Predictor") %>% 
     dplyr::mutate(`Diff. Est.` = `Trim. Mod. Est.` - `Orig. Mod. Est.`) %>% 
     dplyr::mutate(`Diff. p` = `Trim. p` - `Orig. p`) %>% 
     dplyr::mutate(`Orig. Mod. Est.` = numformat(`Orig. Mod. Est.`)) %>% 
     dplyr::mutate(`Orig. p` = numformat(`Orig. p`)) %>% 
     dplyr::mutate(`Trim. Mod. Est.` = numformat(`Trim. Mod. Est.`)) %>% 
     dplyr::mutate(`Trim. p` = numformat(`Trim. p`)) %>% 
     dplyr::mutate(`Diff. Est.` = numformat(`Diff. Est.`)) %>% 
     dplyr::mutate(`Diff. p` = numformat(`Diff. p`)) %>% 
     dplyr::mutate(Predictor = trimws(Predictor))

Mod.ests <- dplyr::left_join(Mod.ests, Trim.Coef.All.N, by = "Predictor") %>% 
    dplyr::mutate(`Diff. Est. 2` = as.numeric(`Trim. All N Mod. Est.`) - 
                      as.numeric(`Orig. Mod. Est.`)) %>% 
    dplyr::mutate(`Diff. p 2` = as.numeric(`Trim. All N p`) - as.numeric(`Orig. p`)) %>% 
    dplyr::mutate(`Trim. All N Mod. Est.` = numformat(`Trim. All N Mod. Est.`)) %>% 
    dplyr::mutate(`Trim. All N p` = numformat(`Trim. All N p`)) %>% 
    dplyr::mutate(`Diff. Est. 2` = numformat(`Diff. Est. 2`)) %>% 
    dplyr::mutate(`Diff. p 2` = numformat(`Diff. p 2`)) %>% 
    dplyr::mutate(Predictor = trimws(Predictor)) %>% 
    dplyr::mutate(Predictor = factor(Predictor,
                                     levels = c("(Intercept)",
                                                "Age_Decades",
                                                "Ethnic_CodeHispanic/Latino",
                                                "Ethnic_CodeOther",
                                                "Education_3catSome college",
                                                "Education_3catTech./College/Grad Degree",
                                                "FinancialWorry_catOften",
                                                "FinancialWorry_catAlmost all the time",
                                                "GenderFemale",
                                                "Divorced_DichotomousDivorced",
                                                "TimePost",
                                                "DomainPartner_Selection",
                                                "DomainPast_Rel_Behav",
                                                "DomainRel_Behav_Attit",
                                                "Prior_RshpEducation_collapsedSome/A lot",
                                                "Number_AttendedTwo Sessions",
                                                "Number_AttendedThree Sessions",
                                                "TimePost:DomainPartner_Selection",
                                                "TimePost:DomainPast_Rel_Behav",
                                                "TimePost:DomainRel_Behav_Attit",
                                                "TimePost:Prior_RshpEducation_collapsedSome/A lot",
                                                "TimePost:Number_AttendedTwo Sessions",
                                                "TimePost:Number_AttendedThree Sessions",
                                                "Ethnic_CodeHispanic/Latino:TimePost",
                                                "Ethnic_CodeOther:TimePost"),
                                     labels = c("Intercept",
                                                "Age (Decades)",
                                                "Hispanic/Latino",
                                                ...
                                                "T X Three Sessions",
                                                "T X Hispanic/Latino",
                                                "T X Another Race/Ethn")))


```


## Comparing Mixed Effects Regression Coefficients

### Estimates

```{r, echo = FALSE}
Mod.ests %>% 
    dplyr::mutate(`Orig. Est. \n N = 134` = `Orig. Mod. Est.`, 
                  `Trimmed Est. \n N = 134` = `Trim. Mod. Est.`, 
                  `Trimmed Est. \n N = 165` = `Trim. All N Mod. Est.`) %>% 
    dplyr::select(Predictor, 
                  `Orig. Est. \n N = 134`, 
                  `Trimmed Est. \n N = 134`, 
                  `Trimmed Est. \n N = 165`) %>% 
    pander::pander(keep.line.breaks = TRUE)
```
...
```{r, echo = FALSE}
Mod.ests %>% 
    dplyr::mutate(`Difference in Est.: \n Orig. N = 134 \n vs. \n Trimmed N = 134` = `Diff. Est.`) %>% 
    dplyr::mutate(`Difference in Est.: \n Orig. N = 134 \n vs. \n Trimmed N = 165` = `Diff. Est. 2`) %>% 
    dplyr::select(Predictor,
                  `Difference in Est.: \n Orig. N = 134 \n vs. \n Trimmed N = 134`,
                  `Difference in Est.: \n Orig. N = 134 \n vs. \n Trimmed N = 165`) %>% 
    pander::pander(keep.line.breaks = TRUE)
...
```{r, echo = FALSE}
Mod.ests %>% 
    dplyr::mutate(`Difference in Sig.: \n Orig. N = 134 \n vs. \n Trimmed N = 134` = `Diff. p`) %>% 
    dplyr::mutate(`Difference in Sig.: \n Orig. N = 134 \n vs. \n Trimmed N = 165` = `Diff. p 2`) %>% 
    dplyr::select(Predictor,
                  `Difference in Sig.: \n Orig. N = 134 \n vs. \n Trimmed N = 134`,
                  `Difference in Sig.: \n Orig. N = 134 \n vs. \n Trimmed N = 165`) %>% 
    pander::pander(keep.line.breaks = TRUE)
...
# test_anova <- afex::aov_4(`Income (10K)` ~ Education_3cat + (1|ID), data = Jail_clean)
# 
# test_anova %>% emmeans::emmeans(~Education_3cat) %>% emmeans::emmip(~Education_3cat, CIs = TRUE)
```

```{r, include = FALSE}
# chisq.test(Jail_clean$FinancialWorry_cat,  Jail_clean$Education_3cat)
# 
# table(Jail_clean$Education_3cat, Jail_clean$FinancialWorry_cat)
...
- **Need to add discussion of removing non-significant predictors to methods section**
...
Model.2.REML <- lme4::lmer(Score ~ Ethnic_Code + 
                             Time +
                             (1|ID),
                         data = Jail_clean_longlong4,
                         REML = TRUE)
...
Average_Gain_b <- Average_Gain_b$coefficients[4]
...
hrs.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
ps.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
prb.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
rba.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
exposure.somealot.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
dosage.twosession.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
dosage.threesession.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
race.hisp.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
...
race.other.coef <- summary(lmerTest::lmer(Score ~ Ethnic_Code + 
                             Time + Domain + Time:Domain +
                             Prior_RshpEducation_collapsed + Number_Attended + 
                             Time:Prior_RshpEducation_collapsed + 
                             Time:Number_Attended + 
