...
subtitle: "Revised Quantitative Analyses and Results: Dropping Non-Significant Predictors"
...
Trim.Coef <- (summary(Model.9.RE.KR, ddf = "Kenward-Roger"))$coefficients


dplyr::left_join(Orig.Coef %>% 
    data.frame() %>% 
    tibble::rownames_to_column() %>% 
...
**Needs to be updated to discuss removal of non-significant predictors**
