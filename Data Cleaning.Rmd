...
Jail_clean <- Jail_raw %>% 
    ...
    dplyr::mutate(`Income (10K)` = Income/10000) %>% 
    dplyr::mutate(`Age (Decades)` = Age/10) %>% 
...
```{r}
PICK_clean_longlong4 <- PICK_clean %>% 
...
# Saving data Set
```{r}
save(PICK_clean, file="./Data/PICK_clean.Rda")
save(PICK_clean_long, file="./Data/PICK_clean_long.Rda")
save(PICK_clean_long2, file="./Data/PICK_clean_long2.Rda")
save(PICK_clean_longlong, file="./Data/PICK_clean_longlong.Rda")
save(PICK_clean_longlong2, file="./Data/PICK_clean_longlong2.Rda")
save(PICK_clean_longlong4, file="./Data/PICK_clean_longlong4.Rda")
