install.packages(c("sem", "semdiag", "semPlot", "semTools",
                   "tidyr", "tidyverse", "haven", "foreign",
                   "bookdown", "furniture", "psych","dplyr", "kableExtra",
                   "knitr", "knitcitations", "knitLatex", "lavaan",
