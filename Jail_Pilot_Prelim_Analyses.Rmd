...
Jail_clean %>% 
    ...
    dplyr::select(Age, 
                  ...
                  RightPartner.3c, LearnPartner.3c, PaceRelationship.3c, WarningSigns.3c,
                  LearnedGrowingUp_Before.3c, PastRelationships_Before.3c, 
                  GetAlongParents_Before.3c, FriendshipsAreLike_Before.3c,
                  LearnedGrowingUp.3c, PastRelationships.3c, GetAlongParents.3c, FriendshipsAreLike.3c,
...
Jail_clean %>% 
    dplyr::mutate(Age_Decades = `Age (Decades)`) %>% 
    dplyr::mutate(Income_10K = `Income (10K)`) %>% 
    dplyr::mutate(`In Larger Analysis Sample` = factor(in.analysis.sample2)) %>% 
    dplyr::select(Age_Decades,
                  Age_Groups,
                  Ethnic_Code, 
                  Education_3cat,
...
## HRS Retrospective-Pre

```{r, echo = FALSE}

fit.HRS.pre <- ltm::grm(Jail_clean %>% 
                    dplyr::select(Healthy_Rel_Before, 
                                  Communicate_Before, 
                                  ConflictManagement_Before) %>% 
                    dplyr::mutate(Healthy_Rel_Before = factor(Healthy_Rel_Before,
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  Communicate_Before = factor(Communicate_Before,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  ConflictManagement_Before = factor(ConflictManagement_Before,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")))
                    # dplyr::mutate(Healthy_Rel_Before.3n = factor(Healthy_Rel_Before.3n,
                    #                                             levels = 3:5,
                    #                                             labels = c("1", "2", "3")), 
                    #               Communicate_Before.3n = factor(Communicate_Before.3n,
                    #                                             levels = 3:5,
                    #                                             labels = c("1", "2", "3")), 
                    #               ConflictManagement_Before.3n = factor(ConflictManagement_Before.3n,
                    #                                             levels = 3:5,
                    #                                             labels = c("1", "2", "3")))
                    )
...
plot(fit.HRS.pre, type = "IIC", items = 0)
```

```{r, echo = FALSE}
hrs.pre.factor.scorse <- factor.scores(fit.HRS.pre,
              method = c("EB"))

hrs.pre.fscores.df <- hrs.pre.factor.scorse$score.dat

fscores.HRS.pre <- Jail_clean %>% 
    dplyr::mutate(Healthy_Rel_Before = factor(Healthy_Rel_Before,
                                       levels = c("Strongly Agree",
                                                  "Agree",
                                                  "Neutral",
    ...
    dplyr::left_join(hrs.pre.fscores.df %>% 
                         dplyr::mutate(Healthy_Rel_Before = factor(Healthy_Rel_Before,
                                                            levels = c(1:3),
                                                            labels = c("Strongly Agree",
                                                                       "Agree",
                                       ...
                                       ConflictManagement_Before = factor(ConflictManagement_Before,
                                                            ...
                                                            labels = c("Strongly Agree",
                                                                       ...
                                                                       "Str. Dis. - Neutral"))))  %>% 
    dplyr::select(ID,
                  Healthy_Rel_Before, Communicate_Before, ConflictManagement_Before,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.HRS.pre = z1) %>% 
    dplyr::select(ID, fscores.HRS.pre)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.HRS.post <- ltm::grm(Jail_clean %>% 
                    dplyr::select(Healthy_Rel, 
                                  Communicate, 
                                  ConflictManagement) %>%
                    dplyr::filter(complete.cases(Healthy_Rel, 
                                  Communicate, 
                                  ConflictManagement)) %>% 
                    dplyr::mutate(Healthy_Rel = factor(Healthy_Rel,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  Communicate = factor(Communicate,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  ConflictManagement = factor(ConflictManagement,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
...
# Jail_clean %>%
#                     dplyr::select(Healthy_Rel.3n, 
#                                   Communicate.3n, 
#                                   ConflictManagement.3n) %>% 
#                     dplyr::mutate(Healthy_Rel.3n = factor(Healthy_Rel.3n,
#                                                                 levels = 3:5,
#                                                                 labels = c("1", "2", "3")), 
#                                   Communicate.3n = factor(Communicate.3n,
#                                                                 levels = 3:5,
#                                                                 labels = c("1", "2", "3")), 
#                                   ConflictManagement.3n = factor(ConflictManagement.3n,
#                                                                 levels = 3:5,
#                                                                 labels = c("1", "2", "3"))) %>% 
    # furniture::tableF(Healthy_Rel)
...
plot(fit.HRS.post, type = "IIC", items = 0)
```
...
```{r, echo = FALSE}
hrs.post.factor.scorse <- factor.scores(fit.HRS.post,
              method = c("EB"))

hrs.post.fscores.df <- hrs.post.factor.scorse$score.dat

fscores.HRS.post <- Jail_clean %>% 
    dplyr::mutate(Healthy_Rel = factor(Healthy_Rel,
                                       levels = c("Strongly Agree",
                                                  "Agree",
                                                  "Neutral",
    ...
    dplyr::left_join(hrs.post.fscores.df %>% 
                         dplyr::mutate(Healthy_Rel = factor(Healthy_Rel,
                                                            levels = c(1:3),
                                                            labels = c("Strongly Agree",
                                                                       "Agree",
                                       ...
                                       ConflictManagement = factor(ConflictManagement,
                                                            ...
                                                            labels = c("Strongly Agree",
                                                                       ...
                                                                       "Str. Dis. - Neutral"))))  %>% 
    dplyr::select(ID,
                  Healthy_Rel, Communicate, ConflictManagement,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.HRS.post = z1) %>% 
    dplyr::select(ID, fscores.HRS.post)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.PS.pre <- ltm::grm(Jail_clean %>% 
                    dplyr::select(RightPartner_Before, 
                                  LearnPartner_Before, 
                                  PaceRelationship_Before,
                                  WarningSigns_Before) %>%
                    dplyr::filter(complete.cases(RightPartner_Before, 
                                  LearnPartner_Before, 
                                  PaceRelationship_Before,
                                  WarningSigns_Before)) %>% 
                    dplyr::mutate(RightPartner_Before = factor(RightPartner_Before,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  LearnPartner_Before = factor(LearnPartner_Before,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  PaceRelationship_Before = factor(PaceRelationship_Before,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  WarningSigns_Before = factor(WarningSigns_Before,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
...
plot(fit.PS.pre, type = "IIC", items = 0)
```



```{r, echo = FALSE}
ps.pre.factor.scorse <- factor.scores(fit.PS.pre,
              method = c("EB"))

ps.pre.fscores.df <- ps.pre.factor.scorse$score.dat

fscores.PS.pre <- Jail_clean %>% 
    dplyr::mutate(RightPartner_Before = factor(RightPartner_Before,
                                       levels = c("Strongly Agree",
                                                  "Agree",
                                                  "Neutral",
    ...
    dplyr::left_join(ps.pre.fscores.df %>% 
                         dplyr::mutate(RightPartner_Before = factor(RightPartner_Before,
                                                            levels = c(1:3),
                                                            labels = c("Strongly Agree",
                                                                       "Agree",
                                       ...
                                       WarningSigns_Before = factor(WarningSigns_Before,
                                                            ...
                                                            labels = c("Strongly Agree",
                                                                       ...
                                                                       "Str. Dis. - Neutral"))))  %>% 
    dplyr::select(ID,
                  RightPartner_Before, LearnPartner_Before, 
                  PaceRelationship_Before,WarningSigns_Before,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.PS.pre = z1) %>% 
    dplyr::select(ID, fscores.PS.pre)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.PS.post <- ltm::grm(Jail_clean %>% 
                    dplyr::select(RightPartner, 
                                  LearnPartner, 
                                  PaceRelationship,
                                  WarningSigns) %>%
                    dplyr::filter(complete.cases(RightPartner, 
                                  LearnPartner, 
                                  PaceRelationship,
                                  WarningSigns)) %>% 
                    dplyr::mutate(RightPartner = factor(RightPartner,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  LearnPartner = factor(LearnPartner,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  PaceRelationship = factor(PaceRelationship,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
                                                                ...
                                                                labels = c("Strongly Agree",
                                                                           ...
                                                                           "Str. Dis. - Neutral",
                                                                           "Str. Dis. - Neutral")),
                                  WarningSigns = factor(WarningSigns,
                                                                levels = c("Strongly Agree",
                                                                           "Agree",
                                                                           "Neutral",
                                                                           "Disgree",
...
plot(fit.PS.post, type = "IIC", items = 0)
```



```{r, echo = FALSE}
ps.post.factor.scores <- factor.scores(fit.PS.post,
              method = c("EB"))

ps.post.factor.scores.df <- ps.post.factor.scores$score.dat

fscores.PS.post <- Jail_clean %>% 
    dplyr::mutate(RightPartner = factor(RightPartner,
                                       levels = c("Strongly Agree",
                                                  "Agree",
                                                  "Neutral",
    ...
    dplyr::left_join(ps.post.factor.scores.df %>% 
                         dplyr::mutate(RightPartner = factor(RightPartner,
                                                            levels = c(1:3),
                                                            labels = c("Strongly Agree",
                                                                       "Agree",
                                       ...
                                       WarningSigns = factor(WarningSigns,
                                                            ...
                                                            labels = c("Strongly Agree",
                                                                       ...
                                                                       "Str. Dis. - Neutral"))))  %>% 
    dplyr::select(ID,
                  RightPartner, LearnPartner, PaceRelationship,WarningSigns,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.PS.post = z1) %>% 
    dplyr::select(ID, fscores.PS.post)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.RP.pre <- ltm::grm(Jail_clean %>% 
                    dplyr::select(LearnedGrowingUp_Before, 
                                  PastRelationships_Before, 
                                  GetAlongParents_Before, 
                                  FriendshipsAreLike_Before) %>%
                    dplyr::filter(complete.cases(LearnedGrowingUp_Before, 
                                  PastRelationships_Before, 
                                  GetAlongParents_Before, 
                                  FriendshipsAreLike_Before)) %>% 
                    dplyr::mutate(LearnedGrowingUp_Before = factor(LearnedGrowingUp_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                           "Crucially Important"),
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           "Umimp. - Somewhat imp.",
                                                                           "Umimp. - Somewhat imp.",
                                                                           "Important",
                                                                           "Crucially Important")),
                                  PastRelationships_Before = factor(PastRelationships_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  GetAlongParents_Before = factor(GetAlongParents_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  FriendshipsAreLike_Before = factor(FriendshipsAreLike_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
...
plot(fit.RP.pre, type = "IIC", items = 0)
```



```{r, echo = FALSE}
rp.pre.factor.scores <- factor.scores(fit.RP.pre,
              method = c("EB"))

rp.pre.factor.scores.df <- rp.pre.factor.scores$score.dat

fscores.RP.pre <- Jail_clean %>% 
    dplyr::mutate(LearnedGrowingUp_Before = factor(LearnedGrowingUp_Before,
                                       levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
    ...
    dplyr::left_join(rp.pre.factor.scores.df %>% 
                         dplyr::mutate(LearnedGrowingUp_Before = factor(LearnedGrowingUp_Before,
                                                            levels = c(1:3),
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       "Important",
                                       ...
                                       FriendshipsAreLike_Before = factor(FriendshipsAreLike_Before,
                                                            ...
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       ...
                                                                       "Crucially Important"))))  %>% 
    dplyr::select(ID,
                  LearnedGrowingUp_Before, PastRelationships_Before, 
                  GetAlongParents_Before, FriendshipsAreLike_Before,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.RP.pre = z1) %>% 
    dplyr::select(ID, fscores.RP.pre)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.RP.post<- ltm::grm(Jail_clean %>% 
                    dplyr::select(LearnedGrowingUp, 
                                  PastRelationships, 
                                  GetAlongParents, 
                                  FriendshipsAreLike) %>%
                    dplyr::filter(complete.cases(LearnedGrowingUp, 
                                  PastRelationships, 
                                  GetAlongParents, 
                                  FriendshipsAreLike)) %>% 
                    dplyr::mutate(LearnedGrowingUp = factor(LearnedGrowingUp,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  PastRelationships = factor(PastRelationships,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  GetAlongParents = factor(GetAlongParents,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  FriendshipsAreLike = factor(FriendshipsAreLike,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
...
plot(fit.RP.post, type = "IIC", items = 0)
```



```{r, echo = FALSE}
rp.post.factor.scores <- factor.scores(fit.RP.post,
              method = c("EB"))

rp.post.factor.scores.df <- rp.post.factor.scores$score.dat

fscores.RP.post <- Jail_clean %>% 
    dplyr::mutate(LearnedGrowingUp = factor(LearnedGrowingUp,
                                       levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
    ...
    dplyr::left_join(rp.post.factor.scores.df %>% 
                         dplyr::mutate(LearnedGrowingUp = factor(LearnedGrowingUp,
                                                            levels = c(1:3),
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       "Important",
                                       ...
                                       FriendshipsAreLike = factor(FriendshipsAreLike,
                                                            ...
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       ...
                                                                       "Crucially Important"))))  %>% 
    dplyr::select(ID,
                  LearnedGrowingUp, PastRelationships, 
                  GetAlongParents, FriendshipsAreLike,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.RP.post = z1) %>% 
    dplyr::select(ID, fscores.RP.post)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.BRA.pre <- ltm::grm(Jail_clean %>% 
                    dplyr::select(Fights_Before, 
                                  FeelingsHurt_Before, 
                                  RightandWrong_Before) %>%
                    dplyr::filter(complete.cases(Fights_Before, 
                                                 FeelingsHurt_Before, 
                                                 RightandWrong_Before)) %>% 
                    dplyr::mutate(Fights_Before = factor(Fights_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  FeelingsHurt_Before = factor(FeelingsHurt_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  RightandWrong_Before = factor(RightandWrong_Before,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
...
plot(fit.BRA.pre, type = "IIC", items = 0)
```



```{r, echo = FALSE}
BRA.pre.factor.scores <- factor.scores(fit.BRA.pre,
              method = c("EB"))

BRA.pre.factor.scores.df <- BRA.pre.factor.scores$score.dat

fscores.BRA.pre <- Jail_clean %>% 
    dplyr::mutate(Fights_Before = factor(Fights_Before,
                                       levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
    ...
    dplyr::left_join(BRA.pre.factor.scores.df %>% 
                         dplyr::mutate(Fights_Before = factor(Fights_Before,
                                                            levels = c(1:3),
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       "Important",
                                       ...
                                       RightandWrong_Before = factor(RightandWrong_Before,
                                                            ...
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       ...
                                                                       "Crucially Important"))))  %>% 
    dplyr::select(ID,
                  Fights_Before, FeelingsHurt_Before, RightandWrong_Before,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.BRA.pre = z1) %>% 
    dplyr::select(ID, fscores.BRA.pre)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
...
fit.BRA.post <- ltm::grm(Jail_clean %>% 
                    dplyr::select(Fights, 
                                  FeelingsHurt, 
                                  RightandWrong) %>%
                    dplyr::filter(complete.cases(Fights, 
                                                 FeelingsHurt, 
                                                 RightandWrong)) %>% 
                    dplyr::mutate(Fights = factor(Fights,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  FeelingsHurt = factor(FeelingsHurt,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
                                                                ...
                                                                labels = c("Umimp. - Somewhat imp.",
                                                                           ...
                                                                           "Important",
                                                                           "Crucially Important")),
                                  RightandWrong = factor(RightandWrong,
                                                                levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
                                                                           "Important",
...
plot(fit.BRA.post, type = "IIC", items = 0)
```


```{r, echo = FALSE}
BRA.post.factor.scores <- factor.scores(fit.BRA.post,
              method = c("EB"))

BRA.post.factor.scores.df <- BRA.post.factor.scores$score.dat

fscores.BRA.post <- Jail_clean %>% 
    dplyr::mutate(Fights = factor(Fights,
                                       levels = c("Unimportant",
                                                                           "Less Important",
                                                                           "Somewhat Important",
    ...
    dplyr::left_join(BRA.post.factor.scores.df %>% 
                         dplyr::mutate(Fights = factor(Fights,
                                                            levels = c(1:3),
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       "Important",
                                       ...
                                       RightandWrong = factor(RightandWrong,
                                                            ...
                                                            labels = c("Umimp. - Somewhat imp.",
                                                                       ...
                                                                       "Crucially Important"))))  %>% 
    dplyr::select(ID,
                  Fights, FeelingsHurt, RightandWrong,
                  z1, se.z1)  %>% 
    dplyr::mutate(fscores.BRA.post = z1) %>% 
    dplyr::select(ID, fscores.BRA.post)
    # dplyr::arrange(Healthy_Rel, Communicate, ConflictManagement)
