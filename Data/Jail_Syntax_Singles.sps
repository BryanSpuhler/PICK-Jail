...
FILTER OFF. 
USE ALL. 
SELECT IF (RelationshipStatusB > 1). 
EXECUTE.

FILTER OFF. 
USE ALL. 
SELECT IF (RelationshipStatusA = 2). 
EXECUTE.
...
* This is what constitutes the file "PICK_Jail_Singles_Working.sav" in the PICK_Jail_R -> Data folder
...
* This is what constitutes the file "Jail_Singles_Trimmed.sav" in the PICK_Jail_R -> Data folder
